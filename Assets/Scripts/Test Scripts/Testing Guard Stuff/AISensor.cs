...
Mesh CreateWedgeMesh(float h)
    {
        ...
        Vector3 topCenter = bottomCenter + Vector3.up * h;
        Vector3 topRight = bottomRight + Vector3.up * h;
        Vector3 topLeft = bottomLeft + Vector3.up * h;
        ...
        for (int i = 0; i < segments; ++i)
        {
            ...
            topRight = bottomRight + Vector3.up * h;
            topLeft = bottomLeft + Vector3.up * h;
    ...
    private void OnValidate()
    {
        ...
        if (mf != null) mf.mesh = gameMesh;

        var mr = GetComponent<MeshRenderer>();
        if (mr != null)
        {
            mr.enabled = showInGame;
            if (mr.sharedMaterial != null)
                mr.sharedMaterial.color = meshColor;
        }
    }
